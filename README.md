...
- **pydantic-v1**: In the Pipfile you need to setup pydantic lower than 2.0.0 `pydantic = "<2.0"` and then run `pipenv update`
- **pydantic-v2**: Change the version of pydantic to pydantic `>=2.0` and then run `pipenv update`
